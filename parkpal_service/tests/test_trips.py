...
def test_get_all():
    # Override the TripsRepository dependency with the FakeTripsRespository
   app.dependency_overrides[TripsRespository] = FakeTripsRespository
